...
const postEndpoint = '/play/edit'

class EditPlayGauge extends Component{
    constructor(props){
        super(props)
    ...
    handleLevelChange(event){
        this.props.handlePlayLevelChange(event.target.value)
    }

    handleAssessmentChange(event){
        this.props.handlePlayAssessmentChange(event.target.value)
    }
