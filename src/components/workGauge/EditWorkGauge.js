...
const postEndpoint = '/work/edit'

class EditWorkGauge extends Component{
    constructor(props){
        super(props)
    ...
    handleLevelChange(event){
        this.props.handleWorkLevelChange(event.target.value)
    }

    handleAssessmentChange(event){
        this.props.handleWorkAssessmentChange(event.target.value)
    }
